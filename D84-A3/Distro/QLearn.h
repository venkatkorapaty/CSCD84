...
int findDeWay(double gr[max_graph_size][4], int cat_loc[10][2], int cats, int cheese_loc[10][2], int cheeses, int mouse_loc[1][2], int *pred, int graph_size, int p[max_graph_size]);

...
//  int adjs[4][2] = {{mouse_loc[0][0], mouse_loc[0][1] - 1}, {mouse_loc[0][0] + 1, mouse_loc[0][1]}, {mouse_loc[0][0], mouse_loc[0][1] + 1}, {mouse_loc[0][0] - 1, mouse_loc[0][1]}};
//  for (int i = 0; i < 4; i++) {
// 	 if (gr[mouse_loc[0][0] + (32 * mouse_loc[0][1])][i]) {
// 		 path[0][0] = adjs[i][0];
// 		 path[0][1] = adjs[i][1];
// 		 return(0.0);
// 	 }
